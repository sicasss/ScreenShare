...
Write-Output ""
Write-Output ""
Write-Output "${yellow}By Diablos473${reset}"
Write-Output ""
Write-Output "${green}  __  __ _       _ _     ____  ____  ${reset}" 
Write-Output "${green} |  \/  (_)     (_) |   / __ \|  _ \ ${reset}"
Write-Output "${green} | \  / |_ _ __  _| |_ | |  | | |_) |${reset}"
Write-Output "${green} | |\/| | | '_ \| | __|| |  | |  _ < ${reset}"
Write-Output "${green} | |  | | | | | | | |_ | |__| | |_) |${reset}"
Write-Output "${green} |_|  |_|_|_| |_|_|\__(_)____/|____/ ${reset}"
Write-Output ""
Write-Output "${yellow}            discord.gg/hazelmc${reset}"
Write-Output ""
