...
Write-Output ""
Write-Host -ForegroundColor Green  " __  __  _        _        ___  ___"
Write-Host -ForegroundColor Green  "|  \/  |(_) _ _  (_)      / __|/ __|"
Write-Host -ForegroundColor Green  "| |\/| || || ' \ | |      \__ \\__ \"
Write-Host -ForegroundColor Green  "|_|  |_||_||_||_||_|      |___/|___/"
Write-Output ""
Write-Output "${yellow}            https://discord.gg/KuMnDSR7wT${reset}"
Write-Output ""
